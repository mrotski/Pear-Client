...
java_path = "java.exe"
lwjgl_path = r"C:\PearClient-main\PearClient\Natives\lwjgl-3.3.1"
game_dir = r"C:\PearClient-main\PearClient\needed_files\data_minecraft"
...
def download_version_files(version_id, versions_dir):
    ...
    if not version_info:
        messagebox.showerror("We ran into an error", f"Version {version_id} not found in the files.")
        return False
...
# GUI
root = tk.Tk()
root.title("Pear Client Alp... eh... Halloween")
...
tk.Label(main_frame, text="Happy Halloween", font=("Helvetica", 20, "bold"), fg="white", bg="#FF5C00").pack(pady=20)

tk.Label(main_frame, text="Choose version:", font=("Helvetica", 14), fg="white", bg="#FF5C00").pack()
...
username_label = tk.Label(main_frame, text="Type your username:", font=("Helvetica", 14), fg="white", bg="#FF5C00")
