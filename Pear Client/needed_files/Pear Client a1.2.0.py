...
# GUI
root = tk.Tk()
root.title("Pear Client Alpha 1.2.0")
...
tk.Label(main_frame, text="PearClient a1.2", font=("Helvetica", 20, "bold"), fg="white", bg="#2e2e2e").pack(pady=20)
...
username_label = tk.Label(main_frame, text="Type your username:", font=("Helvetica", 14), fg="white", bg="#2e2e2e")
